...
<main class="flex-1 p-2 overflow-auto">
    ...
    $columns = [
        ...
        [
            ...
            'label' => 'Đường Phố',
            'contentOptions' => ['class' => 'px-6 py-4 text-sm text-gray-900 hidden md:table-cell'],
            'headerOptions' => ['class' => 'px-6 py-3 text-left text-xs font-medium text-gray-500 capitalize tracking-wider  bg-yellow-500 hover:bg-yellow-600 text-white hidden md:table-cell  text-[12px]'],
            'format' => 'raw',
            'value' => function ($model) {
