...
<div class="flex-1 flex flex-col">
    <!-- Top Header Bar -->
    <header class="bg-white p-4 shadow-md flex items-center justify-between rounded-bl-lg">
        <!-- App Name / Title -->
        <div class="text-lg font-semibold text-gray-800">
            Bản Khác <span class="text-gray-500 text-sm">→ Số 17-19 Phan Đình Phùng, Phường 17, Phú Nhuận, TP.HCM</span>
        </div>
        <!-- Navigation Tabs -->
                ...
                <div class="lg:col-span-1 bg-white p-6 rounded-lg shadow-md space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-orange-500 focus:border-orange-500 sm:text-sm" placeholder="Nhà Mới Xây">
                        </div>
                        <div>
                            <h3 class="text-md font-semibold text-gray-800 mb-3">Nhược Điểm</h3>
                            <input type="text" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-orange-500 focus:border-orange-500 sm:text-sm" placeholder="Đất Top Hill">
                        </div>
                    </div>
                </div>
            </div>
            <!-- Property Data Section (Separate Card) -->
            <div class="bg-white p-6 rounded-lg shadow-md mt-6">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-lg font-semibold text-gray-800">Dữ Liệu Nhà Đất</h2>
                    <div class="flex space-x-2">
                        <button class="px-4 py-2 bg-orange-600 text-white rounded-md shadow-sm hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">LƯU</button>
                        <button class="px-4 py-2 bg-gray-200 text-gray-800 rounded-md shadow-sm hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">QUAY LẠI</button>
                    </div>
                </div>
                <p class="text-sm text-gray-500 mb-4">Màn hình chính / Thêm Dữ Liệu Nhà Đất [5023]</p>
                <!-- Search Bar -->
                <div class="mb-6">
                    <label for="property_search" class="sr-only">Tìm kiếm</label>
                    <input type="text" id="property_search" class="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-orange-500 focus:border-orange-500 sm:text-sm" placeholder="Tìm">
                </div>
                <!-- Features Checklist -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 text-sm text-gray-700">
                    ...
                    <div>
                        ...
                        <span class="ml-2">Căn góc, có hầm bán nông</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        ...
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Nhà Có Nội Thất</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        ...
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Gần Sân Bay,Q,C,X,C</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Nhà Cho Thuê Mặt Tiền</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        ...
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Nhà có thể xây mới</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Nhà không lộ giới</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                    ...
                    <div>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Có Cây Trồng Nhà</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        ...
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Pháp lý (Thanh lý, thanh chấp, chưa hoàn công...)</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Nhà đất chưa có hoa hồng cụ thể</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Dưới Chân Cầu Hoặc Dưới Cẩm Thẻ</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        ...
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Gần Nhà Thờ</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Gần Nhà Bằng Lô</span>
                        </label>
                        <label class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-4 w-4 text-orange-600 rounded">
                        <span class="ml-2">Nhà cũ</span>
                        </label>
                    </div>
                </div>
            </div>
        </div>
        <!-- Sổ Hồng & Hình Ảnh Content Section (Initially Hidden) -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initially activate the "Thông Tin" tab
        activateTab(thongTinTab, thongTinContent);
    });
</script>